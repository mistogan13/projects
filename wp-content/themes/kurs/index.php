              ...
              <article class="entry-item large-post">
                ...
                <div class="entry-img">
                  <a href="blog-single.html">
                    <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/featured_post.jpg" alt="">
                  </a>
                </div>
              ...
              <div class="row items-grid">
                <div class="col-sm-6">
                  <article class="entry-item">
                    <div class="entry-img">
                      <a href="blog-single.html">
                        <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/post_1.jpg" alt="">
                      </a>
                    </div>
                    <div class="entry-header">
                      <a href="#" class="entry-category">Лайфстайл</a>
                ...
                <div class="col-sm-6">
                  <article class="entry-item">
                    <div class="entry-img">
                      <a href="blog-single.html">
                        <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/post_2.jpg" alt="">
                      </a>
                    </div>
                    <div class="entry-header">
                ...
                <div class="col-sm-6">
                  <article class="entry-item">
                    <div class="entry-img">
                      <a href="blog-single.html">
                        <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/post_3.jpg" alt="">
                      </a>
                    </div>
                    <div class="entry-header">
                      <a href="#" class="entry-category">Трэвел</a>
                ...
                <div class="col-sm-6">
                  <article class="entry-item">
                    <div class="entry-img">
                      <a href="blog-single.html">
                        <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/post_4.jpg" alt="">
                      </a>
                    </div>
                    <div class="entry-header">
                      <a href="#" class="entry-category">Лайфстайл</a>
                  ...
                  <ul class="posts-list list-dividers">
                    <li class="entry-li">
                      <article class="post-small clearfix">
                        <div class="entry-img">
                          <a href="blog-single.html">
                            <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/recent_1.jpg" alt="">
                          </a>
                        </div>
                        <div class="entry">
                    ...
                    <li class="entry-li">
                      <article class="post-small clearfix">
                        <div class="entry-img">
                          <a href="blog-single.html">
                            <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/recent_2.jpg" alt="">
                          </a>
                        </div>
                        <div class="entry">
                    ...
                    <li class="entry-li">
                      <article class="post-small clearfix">
                        <div class="entry-img">
                          <a href="blog-single.html">
                            <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/recent_3.jpg" alt="">
                          </a>
                        </div>
                        <div class="entry">
                    ...
                    <li class="entry-li">
                      <article class="post-small clearfix">
                        <div class="entry-img">
                          <a href="blog-single.html">
                            <img src="<?php echo get_stylesheet_directory_uri()  ?>/img/recent_4.jpg" alt="">
                          </a>
                        </div>
                        <div class="entry">
